...
//WiFi
const char* SSID = "Felipe";                // SSID / nome da rede WiFi que deseja se conectar
const char* PASSWORD = "40561800";   // Senha da rede WiFi que deseja se conectar
...
void recebePacote(char* topic, byte* payload, unsigned int length) 
{
    ...
    // Envia a mensagem recebida para o Arduino Uno
    Serial.println(msg);
}
